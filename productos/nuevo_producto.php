  ...
  <table border ="0">
   ...
   <tr>
    ...
    <td>
      <select id="id_tarifa">
        <?php
        colocar_select_general111($tarifas,$conexion,'id_tarifa','vigencia');
...
<?php
function colocar_select_general111($tabla,$conexion,$campo1,$campo2){
  ...
  {
     $sql="select * from destinos  where id_destino = '".$general['id_destino']."' ";
     //echo '<br>2342342324234'.$sql;
      $con = mysql_query($sql,$conexion);
       $arr_con = mysql_fetch_assoc($con);

    echo '<option value="'.$general[$campo1].'" >'.$general[$campo2].'-'.$arr_con['nombre'].'-'.$general['plan'].'</option>';
  }
}


  function  consulta_assoc111($tabla,$campo,$parametro,$conexion)
  {
