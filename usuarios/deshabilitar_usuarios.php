...
$sql_clientes = "select cli.id_usuario,cli.login,cli.nombre,p.nombre_perfil as perfil
from $tabla16 as cli
...
echo '<tr><td>LOGIN</td><td>NOMBRE</td><td>PERFIL</td><td>DESHABILITAR</td></tr>';
...
while($clientes = mysql_fetch_assoc($consulta_clientes))
	{
			...
			//echo '<td>'.$clientes['id_usuario'].'</td>';
			echo '<td><a href ="deshabilitar.php?id_usuario='.$clientes['id_usuario'].'" >DESHABILITAR</a></td>';
