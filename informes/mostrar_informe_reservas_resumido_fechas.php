...
echo '<a href="../informes/mostrar_informe_reservas_resumido_fechas_excell.php?fecha_in='.$_REQUEST['fecha_in'].'&fecha_fin='.$_REQUEST['fecha_fin'].'">ENVIAR EXCELL</a>';
...
//////////////////////////destinos
        ...
        echo '<td align="right">'.number_format($arr_calor_cxp['valor_total'], 0, ',', '.') .'</td>';
        echo '<td align="right">'.number_format($arr_recibos_proveedores['suma_recibos'], 0, ',', '.') .'</td>';
          echo '<td align="right">'.number_format($saldo_proveedores, 0, ',', '.') .'</td>';
        echo '</tr>';
  ...
  echo '<td></td>';
   echo '<td></td>';
    echo '<td></td>';
     ...
     echo '<td></td>';
      echo '<td>TOTALES</td>';
       echo '<td align="right">'.number_format($suma_valor_reserva, 0, ',', '.') .'</td>';
       echo '<td align="right">'.number_format($suma_recibos_reserva, 0, ',', '.') .'</td>';
       echo '<td align="right">'.number_format($suma_saldo_reserva, 0, ',', '.') .'</td>';
       echo '<td align="right">'.number_format($suma_proveedores, 0, ',', '.') .'</td>';
       echo '<td align="right">'.number_format($suma_recibos_proveedores, 0, ',', '.') .'</td>';
       echo '<td align="right">'.number_format($suma_saldo_proveedores, 0, ',', '.') .'</td>';
  echo '<tr>';
  echo '</tbody>';
  echo '</table>';
