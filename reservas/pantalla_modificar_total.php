...
<body>
  <?php
  echo '<input type="hidden" id="id_reserva"  value = "'.$_REQUEST['id_reserva'].'" >';
...
</td><input type="text" id="no_contrato123" class ="fila_llenar" value = "<?php  echo $datos_reserva['no_contrato'] ?>"></td>
</td></td>
</td></td>
</tr>
</td>NUMERO DE RADICADO RESERVA NEGOCIO</td>
</td><input type="text" id="no_radicado" class ="fila_llenar" value = "<?php  echo $datos_reserva['no_reserva'] ?>"></td>
</td></td>
</td></td>
</tr>
<br><br>
  ...
  <table class ="formato_tabla"  border="0" width="<?php echo $ancho_tabla;  ?>"  style="font-size:<?php echo $tamano_letra; ?>">
    ...
    <tr>
        <td>TARIFA DE VENTA </td>
         <td colspan= "4">
          <select id="id_tarifa" name="id_tarifa" class="fila_llenar">
            <?php 
            //colocar_select_general($productos,$conexion,'id_producto','nombre'); 

             colocar_select_general_condicion_mejorada321($tarifas,$conexion,'id_tarifa','vigencia',$datos_reserva['id_tarifa']);
...
<tr>
 <td>PORCENTAJE CUOTA INICIAL
  <input type ="text" 
  id = "valor_porcentaje_cuota_inicial" 
  value = "<?php echo $datos_reserva['porcentaje_cuota_inicial'];   ?>" size="2px" class="fila_llenar">%</td>
 <td>NUMERO DE CUOTAS <input type="text"  id="no_cuotas" class="fila_llenar" size = "10px"  value = "<?php echo $datos_reserva['no_cuotas'];  ?>" > </td> 
</tr>
</table> 
...
<table class ="formato_tabla"  border="1" width="<?php echo $ancho_tabla;  ?>"  style="font-size:<?php echo $tamano_letra; ?>">
          ...
          <tr>
            ...
            <td colspan = "5"><input type="text"  id="total" 
              size = "10px" onfocus="blur();"
      ...
      <tr>
        ...
        <td>
          <input type="text"  id="vr_inicial" class="fila_llenar" size = "10px" onfocus="blur();"   
          value = "<?php echo $datos_reserva['vr_inicial'];  ?>"></td>
