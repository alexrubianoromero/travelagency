...
echo '<BR><BR>';
echo '<h3>MODIFICACION RECIBOS EGRESO</h3>';
echo '<br><br>';
echo '<table border = "1" >';
echo '<tr>';
...
echo '</tr>';
echo '<td>PROVEEDOR</td><td>'.$datos_proveedor['nombre'].'<input type="hidden" id="id_proveedor" value = "'.$datos_cxp['id_proveedor'].'"></td>';
echo '</tr>';
echo '</tr>';
